...
> A DeepSeek Harness **side-effect plugin** with a configuration schema, generated by [`@allis-plugin/create-dsh`](https://www.npmjs.com/package/@allis-plugin/create-dsh).
