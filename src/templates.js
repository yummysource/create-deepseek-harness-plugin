...
export const PITFALLS = [
  ...
  'A patch row accepts only `id`, `name`, `config`, `inject`, `group`, and `disabled`. Any other key — `schema`, `options`, `settings` — is ignored in silence, so a misspelled config block leaves the schema defaults in force and nothing warns you.',
